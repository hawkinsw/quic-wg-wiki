...
* [Wireshark](https://wireshark.org/) has a GQUIC decoder<sup>1</sup>. HTTP analysis is possible via integration with the [HTTP/2 decoder](https://wiki.wireshark.org/HTTP2).
