...
- **Handshake:** TLS 1.3
- **Protocol IDs:** `0xff00001b`, `0xff00001a`, `0xff000019`
- **Public server:**
  - quic.aiortc.org:443
...
- **Language:** C
- **Version:** draft-24 and 25
- **Roles:** Server, Client
- **Handshake:** RFC 8446
- **Protocol IDs:** `0xff000018`, `0xff000019`
- **ALPN:** `h3-25`, `h3-24`. `hq-25` and `hq-24` available upon request.
...
- **Language:**  C
- **Version:** Draft-27, Draft-25, Q043, Q046, and Q050.
- **Roles:** Client, Server, Library
- **Handshake:** QUIC Crypto, RFC 8446
- **Protocol IDs:** `0xff00001B`, `0xff000019`
- **Public server:**
  - http3-test.litespeedtech.com:4433, http3-test.litespeedtech.com:4434 (sends stateless retry packets), and http3-test.litespeedtech.com:4435 (faster downloads due to less logging) for ID-27 and ID-25 as well as Google QUIC versions Q043, Q046, and Q050
...
- **Language:** C
- **Version:** draft-23, draft-24, draft-25
- **Roles:** server
...
- **Protocol IDs:** `0xff00001b`, `0xff000019`
- **Public server:** test.privateoctopus.com:4433 (server log accessible at https://test.privateoctopus.com/). Use port 4434 to test replies.
...
- **Language:** Rust
- **Version:** draft-23, draft-24, draft-25, draft-27
- **Roles:** library, client, server
- **Handshake:** TLSv1.3 (RFC8446)
- **Protocol IDs:** `0xff000017`, `0xff000018`, `0xff000019`, `0xff00001b`
...
- **HTTP over QUIC Version:** draft-27
- **Roles:** library
- **Public server:** nghttp2.org:4433
...
- **Language:** C
- **Version:** [-14](https://tools.ietf.org/html/draft-ietf-quic-qpack-14)
