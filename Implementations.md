...
[mozquic](https://github.com/mcmanus/mozquic) | an iQUIC library - eventually meant to support both transport and http features. Very nascent, but meant to track standardization milestones. | c++ with C interface | | library client and server | tls 1.3 -20; plausibly -18| 0xff000004 and 0xf123f0c5
